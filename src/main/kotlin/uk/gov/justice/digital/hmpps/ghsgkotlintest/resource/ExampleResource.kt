package uk.gov.justice.digital.hmpps.ghsgkotlintest.resource
...
import uk.gov.justice.digital.hmpps.ghsgkotlintest.service.ExampleApiService
...
class ExampleResource(private val exampleApiService: ExampleApiService) {
  ...
  @Operation(
    ...
    security = [SecurityRequirement(name = "gh-sg-kotlin-test-ui-role")],
    responses = [
